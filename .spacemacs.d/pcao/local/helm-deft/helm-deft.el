...
emacs `deft' extension"
  (interactive)
    (setq helm-ag--default-directory (quote "~/Dropbox/w/notes/"))
    (setq helm-ag--last-default-directory (quote "~/Dropbox/w/notes/"))
